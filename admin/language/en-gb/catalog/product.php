...
$_['column_lots_quantity']        = 'Lots Quantity';
...
//for product views and count date start
$_['column_date']        = 'Date';
$_['help_date']          = 'Click to sort the registration values in the order they were modified!';
$_['help_chart']         = 'Product views decreasing';
$_['help_chart_down']    = 'Product views decreased by more than 50%';
$_['help_chart_up']      = 'Product views increased';
$_['column_viewed']      = 'Viewed';
//for product views and count date end
