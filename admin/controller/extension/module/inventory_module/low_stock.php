...
class ControllerExtensionModuleInventoryModuleLowStock extends Controller { 
	...
	public function export() {
		if (!$this->user->hasPermission('modify', 'extension/module/inventory_module/low_stock')) {
		...
		$low_stock_limit = 5;
		$results = $this->model_extension_module_inventory_module_low_stock->getLowStockProducts($low_stock_limit, $filter_data);
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/inventory_module/low_stock', 'user_token=' . $user_token . $url, true)
        );
        ...
        $base_route = 'extension/module/inventory_module/low_stock';
        ...
        $low_stock_limit = 5; 
        $results = $this->model_extension_module_inventory_module_low_stock->getLowStockProducts($low_stock_limit, $filter_data);
        $product_total = $this->model_extension_module_inventory_module_low_stock->getTotalLowStockProducts($low_stock_limit, $filter_data);
