	...
	public function getOrderStatuses($data = array()) {
		if ($data) {
			...
			if (!$order_status_data) {
                    $query = $this->db->query("SELECT order_status_id, name, sort_order FROM " . DB_PREFIX . "order_status WHERE language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY sort_order ASC");
