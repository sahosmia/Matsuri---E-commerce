...
class __TwigTemplate_39702aa8d49421da1c5c92086286c6289976068643ca232d44606b07026cf042 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"cart-page\">
        ...
        if (($context["coupon_status"] ?? null)) {
          ...
          <div class=\"title section-title\">";
            // line 120
            echo ($context["heading_coupon_block"] ?? null);
            echo "</div>
...
(function (\$) {
  ...
  \$('#button-coupon-cart').on('click', function () {
    ...
    \$.ajax({
      url: '";
            // line 149
            echo ($context["coupon_ajax_url"] ?? null);
            echo "',
      type: 'post',
      ...
      success: function (json) {
        ...
        if (json['redirect']) {
          ...
          \$.get(reloadUrl, function (html) {
            ...
            if (okMsg) {
              \$msg.addClass('text-success').removeClass('text-danger').html(okMsg).show();
            }
          }).fail(function () {
...
//--></script>
        ...
        <div class=\"cart-bottom\">
          <div class=\"panels-total\">
              ";
        // line 198
        if ((($context["modules"] ?? null) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 198), "get", [0 => "cartPanelsStatus"], "method", false, false, false, 198))) {
            // line 199
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["total"]) {
            // line 215
            echo "                    ";
            if ((twig_get_attribute($this->env, $this->source, $context["total"], "code", [], "any", false, false, false, 215) == "sub_total")) {
                // line 216
                echo "                      ";
                $context["sub_total"] = $context["total"];
                // line 217
                echo "                    ";
            } elseif ((twig_get_attribute($this->env, $this->source, $context["total"], "code", [], "any", false, false, false, 217) == "coupon")) {
                // line 218
                echo "                      ";
        ...
        if (($context["sub_total"] ?? null)) {
            ...
            // line 226
            echo twig_get_attribute($this->env, $this->source, ($context["sub_total"] ?? null), "title", [], "any", false, false, false, 226);
            echo ":</strong></td>
                      <td class=\"text-right\">";
            // line 227
            echo twig_get_attribute($this->env, $this->source, ($context["sub_total"] ?? null), "text", [], "any", false, false, false, 227);
            echo "</td>
                    </tr>
                  ";
        }
        ...
        if (($context["coupon_total"] ?? null)) {
            ...
            echo "                    <tr>
                      <td class=\"text-right\"><strong>";
            // line 233
            echo twig_get_attribute($this->env, $this->source, ($context["coupon_total"] ?? null), "title", [], "any", false, false, false, 233);
            echo ":</strong></td>
                      <td class=\"text-right\">";
            // line 234
            echo twig_get_attribute($this->env, $this->source, ($context["coupon_total"] ?? null), "text", [], "any", false, false, false, 234);
            echo "</td>
                    </tr>
                  ";
        }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["total"]) {
            ...
            echo "                    <tr>
                      <td class=\"text-right\"><strong>";
            // line 240
            echo twig_get_attribute($this->env, $this->source, $context["total"], "title", [], "any", false, false, false, 240);
            echo ":</strong></td>
                      <td class=\"text-right\">";
            // line 241
            echo twig_get_attribute($this->env, $this->source, $context["total"], "text", [], "any", false, false, false, 241);
            echo "</td>
                    </tr>
                  ";
        }
