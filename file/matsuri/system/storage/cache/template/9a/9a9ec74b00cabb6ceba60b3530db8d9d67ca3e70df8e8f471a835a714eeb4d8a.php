...
class __TwigTemplate_ad0bf78998cff07309ab700abc118fa1983927fd75688637deb7e929d8169136 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table table-bordered\">
      ...
      <tbody>
        ";
          ...
          <td>";
                // line 89
                echo twig_get_attribute($this->env, $this->source, $context["product"], "sku", [], "any", false, false, false, 89);
                echo "</td>
          <td class=\"text-right\">";
                // line 90
