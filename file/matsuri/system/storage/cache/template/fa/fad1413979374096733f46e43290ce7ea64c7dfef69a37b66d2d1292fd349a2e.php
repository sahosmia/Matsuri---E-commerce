...
class __TwigTemplate_57ed6d1add0c4c09055e13c981a0abc5e35000b83f8fcfce0b4234114b4d6d3e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
(function (\$) {
  var couponSuccessDefault = ";
            // line 136
            echo json_encode(($context["coupon_success_text"] ?? null));
            echo ";
...
//--></script>
        ...
        <div class=\"cart-bottom\">
          <div class=\"panels-total\">
              ";
        // line 219
        if ((($context["modules"] ?? null) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 219), "get", [0 => "cartPanelsStatus"], "method", false, false, false, 219))) {
            // line 220
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["total"]) {
            // line 236
            echo "                    ";
            if ((twig_get_attribute($this->env, $this->source, $context["total"], "code", [], "any", false, false, false, 236) == "sub_total")) {
                // line 237
                echo "                      ";
                $context["sub_total"] = $context["total"];
                // line 238
                echo "                    ";
            } elseif ((twig_get_attribute($this->env, $this->source, $context["total"], "code", [], "any", false, false, false, 238) == "coupon")) {
                // line 239
                echo "                      ";
        ...
        if (($context["sub_total"] ?? null)) {
            ...
            // line 247
            echo twig_get_attribute($this->env, $this->source, ($context["sub_total"] ?? null), "title", [], "any", false, false, false, 247);
            echo ":</strong></td>
                      <td class=\"text-right\">";
            // line 248
            echo twig_get_attribute($this->env, $this->source, ($context["sub_total"] ?? null), "text", [], "any", false, false, false, 248);
            echo "</td>
                    </tr>
                  ";
        }
        ...
        if (($context["coupon_total"] ?? null)) {
            ...
            echo "                    <tr>
                      <td class=\"text-right\"><strong>";
            // line 254
            echo twig_get_attribute($this->env, $this->source, ($context["coupon_total"] ?? null), "title", [], "any", false, false, false, 254);
            echo ":</strong></td>
                      <td class=\"text-right\">";
            // line 255
            echo twig_get_attribute($this->env, $this->source, ($context["coupon_total"] ?? null), "text", [], "any", false, false, false, 255);
            echo "</td>
                    </tr>
                  ";
        }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["total"]) {
            ...
            echo "                    <tr>
                      <td class=\"text-right\"><strong>";
            // line 261
            echo twig_get_attribute($this->env, $this->source, $context["total"], "title", [], "any", false, false, false, 261);
            echo ":</strong></td>
                      <td class=\"text-right\">";
            // line 262
            echo twig_get_attribute($this->env, $this->source, $context["total"], "text", [], "any", false, false, false, 262);
            echo "</td>
                    </tr>
                  ";
        }
