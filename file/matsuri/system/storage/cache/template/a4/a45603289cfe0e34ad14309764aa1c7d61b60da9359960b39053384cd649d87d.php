...
class __TwigTemplate_6a9c849f379b2070d272c85f7a116cf94c14fae8f2d6856700ee9119c1a46e66 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["coupon_status"] ?? null)) {
            ...
            echo "                <div class=\"cart-coupon\">
                  <div class=\"form-group\" style=\"margin-bottom: 12px;\">
                    <label class=\"control-label\" for=\"input-coupon-cart\" style=\"display:block; margin-bottom:6px;\">";
            // line 132
            ...
            echo "</button>
                ...
                <style>
                  /* Keep coupon aligned with totals on Journal3 cart */
                  #checkout-cart .cart-total .cart-coupon { max-width: 420px; margin-left: auto; }
                </style>
...
\$('#button-coupon-cart').on('click', function() {
  \$.ajax({
    ...
    success: function(json) {
      ...
      if (json['redirect']) {
        // Force a fresh totals recalculation view
...
//--></script>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["total"]) {
            ...
            // line 184
            echo twig_get_attribute($this->env, $this->source, $context["total"], "title", [], "any", false, false, false, 184);
            echo ":</strong></td>
                      <td class=\"text-right\">";
            // line 185
            echo twig_get_attribute($this->env, $this->source, $context["total"], "text", [], "any", false, false, false, 185);
            echo "</td>
                    </tr>
                  ";
        }
