...
class __TwigTemplate_6934d8b5c9a06f71337e58368da241fb15473e364e71d2903bd726d0172e137b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script type=\"text/html\" id=\"quick-checkout\">
  <div v-bind:class=\"[(account === '') && !customer_id ? 'login-active' : '']\">
      ...
      <div class=\"right\">
        ...
        // line 57
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 57), "get", [0 => "sectionTitlePaymentDetails"], "method", false, false, false, 57);
        echo "</div>
...
";
    ...
    {
        return array (  189 => 71,  185 => 70,  177 => 65,  166 => 57,  160 => 54,  155 => 52,  149 => 49,  144 => 47,  135 => 41,  130 => 39,  125 => 37,  120 => 35,  111 => 29,  107 => 28,  97 => 22,  91 => 20,  89 => 19,  83 => 17,  75 => 13,  73 => 12,  68 => 10,  62 => 8,  60 => 7,  57 => 6,  46 => 4,  42 => 3,  37 => 1,);
    }
